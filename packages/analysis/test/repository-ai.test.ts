...
/** Fully-detected: Dockerfile, start command, port, Postgres with evidence â€” no question should fire. */
...
describe('collectUnresolvedQuestions', () => {
  ...
  it('flags monorepo-target for a â‰¥3-package.json workspace with no root start script or Dockerfile', () => {
    const tree: FileTree = {
