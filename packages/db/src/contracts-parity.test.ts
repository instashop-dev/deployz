...
describe('enum parity with @deployz/contracts zod schemas', () => {
  const pairs = [
    ...
    ['billingCheckoutIntentStatus', billingCheckoutIntentStatusEnum, billingCheckoutIntentStatusSchema.options],
    ...
    ['deploymentBillingState', deploymentBillingStateEnum, deploymentBillingStateSchema.options],
