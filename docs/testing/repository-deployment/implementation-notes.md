...
| 3 Wave 1 (10) | full funnel, serial, systemic fixes | In progress — see section 7; 6 of 10 attempted (gatus PASS, ihatemoney PASS, umami CONTAINER_START_ERROR ×4 (DEPLOY-007 suspected), docuseal harness-false-fail rerun pending, miniflux BUILD_ERROR rerun pending, kutt DATABASE_ERROR after six attempts that each exposed one layer); DEPLOY-006 fixed (#200); DEPLOY-008 (#206), DEPLOY-009 (#207), DEPLOY-010 (#208), DEPLOY-011 (#209), DEPLOY-012 (#210), DEPLOY-013 (#211/#212), DEPLOY-005 (#212) fixed and deployed; DEPLOY-007 confirmed, fix in review (#213); ghostfolio, directus, memos, outline resumed while #213 is reviewed; harness fixes #199/#201/#202/#204/#205 |
