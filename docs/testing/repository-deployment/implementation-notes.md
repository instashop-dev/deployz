...
| 3 Wave 1 (10) | full funnel, serial, systemic fixes | In progress — see section 7; 2 of 10 complete (gatus PASS, umami CONTAINER_START_ERROR); DEPLOY-006 found and fixed (PR #200); DEPLOY-007 found (fix proposed, product decision pending); harness fixes #199/#201/#202/#204 |
...
| repo-007, repo-021, repo-016, repo-039 | — | not attempted — wave stopped | Systemic-bug rule: ghostfolio, directus and outline need vendor/generated secrets at boot (DEPLOY-009); memos would boot against SQLite until the post-install pass. Resume after the DEPLOY-009 decision |
